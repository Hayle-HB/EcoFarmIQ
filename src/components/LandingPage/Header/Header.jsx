...
const Header = () => {
  ...
  return (
    <div id="header" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          >
            ...
            >
              Transform Your
              <motion.span
                className={`block mt-2 ${isDarkMode ? "text-green-400" : "text-green-400"}`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
              <button className={`w-full sm:w-auto px-6 sm:px-8 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 ${
                isDarkMode 
              ...
              <button className={`w-full sm:w-auto border-2 px-6 sm:px-8 py-3 rounded-lg font-medium transition-all duration-300 ${
                isDarkMode
      ...
      >
        <div className={`w-6 sm:w-8 h-10 sm:h-12 border-2 rounded-full flex justify-center ${
